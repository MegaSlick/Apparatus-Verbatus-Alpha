...
# These pins cover semantic run-tree content, not file count alone. They may
# change only after this module's own orchestration and digest helpers re-measure
# happy at 65 files / exit 0 and review at 72 files / exit 3.
