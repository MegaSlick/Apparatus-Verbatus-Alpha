...
your model per seat (one Opus, one Fable); the receipt names the model that actually
answered, not the seat's requested label — see `.claude/skills/reviewer-pass/SKILL.md`.
