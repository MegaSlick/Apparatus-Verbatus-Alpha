...
The project lead decides what counts as small, reasonable, and well.
...
type, source, and reason. There is no directory-wide exception: an image not
deliberately declared is refused before it enters Git history.
