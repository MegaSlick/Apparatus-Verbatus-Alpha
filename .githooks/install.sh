...
echo ""
echo "  Enforced on the server, out of reach of anything local:"
echo "    main takes a pull request and will not merge with CI red."
echo "    Force-pushing and deleting main are refused, and the rules"
echo "    apply to the owner too. README.md records the arrangement."
echo ""
